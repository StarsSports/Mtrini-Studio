      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 text-neutral-500 font-sans border-l border-[#E5DFD3] bg-[#FCFCFA]">
        <div className="text-center max-w-sm space-y-3.5 select-none">
          ...
          <button
              ...
              className="mt-4 flex items-center justify-center gap-2 w-full p-3 border-2 border-dashed border-[#E2DFD3] rounded-xl text-xs font-bold text-neutral-600 hover:border-amber-400 hover:text-amber-700 hover:bg-amber-50 transition-all"
          >
          ...
          <input type="file" ref={fileInputRef} className="hidden" onChange={(e) => {
            ...
            if(file) {
                // In a real implementation we would pass this to the backend
